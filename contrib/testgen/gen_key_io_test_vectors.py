...
bech32_templates = [
  ...
  ('sol',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('sol',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('sol',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tsol',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tsol',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tsol',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rsol',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rsol',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rsol', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tsol',  17, 32, False, False, False),
  ('rsol',  3,  1, False, False, False),
  ('sol',   15, 41, False, False, False),
  ('tsol',  0, 16, False, False, False),
  ('rsol',  0, 32, True,  False, False),
  ('sol',   0, 16, True,  False, False),
  ('tsol',  0, 32, False, True,  False),
  ('rsol',  0, 20, False, False, True)
]
