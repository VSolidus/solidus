# Support for Output Descriptors in Solidus Core

Since Solidus Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `sol1...` for mainnet or `tsol1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Solidus's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Solidus Core wallets, a convenience function `combo` is
