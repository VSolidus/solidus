...
* Update manpages, see [gen-manpages.sh](https://github.com/solidus-project/solidus/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### Solidus maintainers/release engineers, update version in sources
...
### Build and sign VSolidus Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit solidus=v${VERSION} ../solidus/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit solidus=v${VERSION} ../solidus/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit solidus=v${VERSION} ../solidus/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`solidus-${VERSION}-osx-unsigned.dmg`, `solidus-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import solidus/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
- Detached signatures will then be committed to the [solidus-detached-sigs](https://github.com/solidus-project/solidus-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the solidus.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the solidus.org server.

```

- Update solidus.org version

- Announce the release:

  - solidus-dev and solidus-dev mailing list

  - blog.solidus.org blog post
  ...
  - Create a [new GitHub release](https://github.com/solidus-project/solidus/releases/new) with a link to the archived release notes.
