...
1. Clone the Solidus Core source code:

        git clone https://github.com/VSolidus/solidus
        cd solidus
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/solidus/src
        cp solidusd /usr/local/bin/
        cp solidus-cli /usr/local/bin/
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Solidus"

    touch "/Users/${USER}/Library/Application Support/Solidus/solidus.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Solidus/solidus.conf"

The first time you run solidusd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
