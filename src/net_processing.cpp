...
static constexpr int64_t STALE_CHECK_INTERVAL = 30 * 24 * 60 * 60; // 30 days
...
/// protection against fingerprinting. Set to three months, denominated in seconds.
static constexpr int STALE_RELAY_AGE_LIMIT = 90 * 24 * 60 * 60;
/// Age after which a block is considered historical for purposes of rate
/// limiting block relay. Set to one year, denominated in seconds.
static constexpr int HISTORICAL_BLOCK_AGE = 365 * 24 * 60 * 60;
