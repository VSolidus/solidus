...
const char* BIP71_MIMETYPE_PAYMENT = "application/solidus-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/solidus-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/solidus-paymentrequest";
#endif
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("solidus://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'solidus://' is not a valid URI. Use 'solidus:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Solidus address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
